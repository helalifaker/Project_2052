 ...
 */
export function ProfitabilityJourneyChart({
  data,
  contractEndYear,
        ...
        <div className="flex items-start justify-between">
          <div className="space-y-1">
            ...
            <p className="text-sm text-muted-foreground">
              Revenue, costs, and net income trajectory across all periods (2023-{contractEndYear})
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 bg-muted/30 rounded-lg p-4">
          {breakevenYear && (
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xs text-muted-foreground">Breakeven Year</div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-xs text-muted-foreground">Peak Profitability</div>
