...
async function seedTransitionConfig() {
  try {
    ...
    console.log(
      "   2025:",
      config.year2025Students,
      "students @",
      config.year2025AvgTuition.toString(),
      "SAR",
    );
    console.log(
      "   2026:",
      config.year2026Students,
      "students @",
      config.year2026AvgTuition.toString(),
      "SAR",
    );
    console.log(
      "   2027:",
      config.year2027Students,
      "students @",
      config.year2027AvgTuition.toString(),
      "SAR",
    );
    console.log(
      "   Rent Growth:",
      config.rentGrowthPercent.toString(),
      "% from 2024",
    );
    console.log(
