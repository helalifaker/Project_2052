...
async function verify() {
  try {
    ...
    if (systemConfig) {
      ...
      console.log(
        "  Discount Rate:",
        systemConfig.discountRate?.toString() ?? "NOT SET",
      );
      console.log(
        "  Debt Interest Rate:",
        systemConfig.debtInterestRate.toString(),
      );
      console.log(
        "  WACC:",
        (systemConfig as any).wacc?.toString() ?? "NOT SET",
      );
    ...
    if (proposal) {
      ...
      if (metrics) {
        ...
        console.log(
          "  Contract Total Rent:",
          metrics.contractTotalRent ?? "NOT SET",
        );
        console.log(
          "  Contract Rent NPV:",
          metrics.contractRentNPV ?? "NOT SET",
        );
        console.log(
          "  Contract Total EBITDA:",
          metrics.contractTotalEbitda ?? "NOT SET",
        );
        console.log(
          "  Contract End Year:",
          metrics.contractEndYear ?? "NOT SET",
        );
      } else {
